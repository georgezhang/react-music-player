...
var ReactJkMusicPlayer = /*#__PURE__*/function (_PureComponent) {
  ...
  function ReactJkMusicPlayer(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onControllerDrag", function (e, _ref5) {
      var x = _ref5.x,
          y = _ref5.y;
      var _this$state6 = _this.state,
          moveX = _this$state6.moveX,
          moveY = _this$state6.moveY;
    ...
    _defineProperty(_assertThisInitialized(_this), "onControllerDragStart", function (e, _ref6) {
      var x = _ref6.x,
          y = _ref6.y;
      _this.isDrag = false;
    ...
    _defineProperty(_assertThisInitialized(_this), "onControllerDragStop", function (e, _ref7) {
      var x = _ref7.x,
          y = _ref7.y;
    ...
    _defineProperty(_assertThisInitialized(_this), "onTogglePlay", function () {
      ...
      if (_this.state.audioLists.length >= 1) {
        var _ref8 = _this.props.volumeFade || {},
            fadeIn = _ref8.fadeIn,
            fadeOut = _ref8.fadeOut;

        var _this$state7 = _this.state,
            currentVolumeFade = _this$state7.currentVolumeFade,
            currentVolumeFadeInterval = _this$state7.currentVolumeFadeInterval;
    ...
    _defineProperty(_assertThisInitialized(_this), "loadAndPlayAudio", function () {
      ...
      var _this$state8 = _this.state,
          isInitRemember = _this$state8.isInitRemember,
    ...
    _defineProperty(_assertThisInitialized(_this), "onAudioVolumeChange", function () {
      ...
      var _this$state11 = _this.state,
          currentVolumeFade = _this$state11.currentVolumeFade,
          currentAudioVolume = _this$state11.currentAudioVolume;
  ...
  _createClass(ReactJkMusicPlayer, [{
    ...
    value: function render() {
      ...
      var _this$props4 = this.props,
          ...
          alwaysMobile = _this$props4.alwaysMobile;
      ...
      return /*#__PURE__*/(0, _reactDom.createPortal)( /*#__PURE__*/_react["default"].createElement("div", {
        ...
        ref: this.player,
        tabIndex: "-1"
      }, (alwaysMobile || toggle && isMobile && responsive) && /*#__PURE__*/_react["default"].createElement(_PlayerMobile["default"], {
        playing: playing,
        loading: loading,
        name: name,
        singer: singer,
      ...
      }, _slider.sliderBaseOptions))), PlayModeComponent, LyricComponent, /*#__PURE__*/_react["default"].createElement("span", {
